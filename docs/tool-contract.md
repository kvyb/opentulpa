...
| `source_read` | `evolution` | `read` | `auto` | `none` | `sync` | 30s |
| `source_write` | `evolution` | `update` | `auto` | `none` | `sync` | 30s |
| `source_edit` | `evolution` | `update` | `auto` | `none` | `sync` | 30s |
| `source_bash` | `evolution` | `execute` | `auto` | `none` | `sync` | 660s |
| `source_activate` | `evolution` | `authorize` | `auto` | `required` | `sync` | 60s |
