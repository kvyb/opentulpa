...
def build_application(*, project_root: Path, settings: Settings) -> ApplicationComposition:
    ...
    try:
        ...
        app = create_app(
            ...
            meta_messenger_tenant_id=owner_tenant_id,
            meta_messenger_trigger_id=settings.meta_messenger_trigger_id,
            meta_messenger_verify_token=settings.meta_messenger_verify_token,
