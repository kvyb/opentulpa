...
def main() -> None:
    ...
    if openai_compatible_api_key:
        agent_runtime = OpenTulpaLangGraphRuntime(
            ...
            browserbase_base_url=settings.browserbase_base_url,
            browserbase_proxy_country_code=settings.browserbase_proxy_country_code,
            browserbase_solve_captchas=settings.browserbase_solve_captchas,
            browserbase_advanced_stealth=settings.browserbase_advanced_stealth,
