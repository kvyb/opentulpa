...
PROMPT_POLICY_BLOCKS: list[tuple[str, str, list[tuple[str, str]]]] = [
    (
        ...
        [
            ...
            ("A14", "During live interactive owner/support turns, use concise attached tool-call prose or send_owner_update for intentional interim progress messages when you will continue working with tools."),
            ("A15", "For long-running live interactive owner/support work, call send_owner_update once early when you expect multiple tool calls, slow file processing, browser/search work, or terminal checks; optionally send another update after a major milestone. Do not use send_owner_update for workflow setup, inbound lead/intake processing, routine wakes, or background event notifications."),
