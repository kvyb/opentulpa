    ...
    if normalized == "workflow_setup":
        return SystemMessage(
            content=(
                ...
                "Do not send interim Telegram updates from attached tool-call prose or send_owner_update; workflow setup should publish only through its normal proposal/final delivery path.\n"
