"""Browser Use Cloud helpers for stealth browser sessions."""
...
class BrowserUseCloudClient:
    """Small async wrapper around Browser Use Cloud profile/browser APIs."""
    ...
    async def create_profile(self, *, name: str) -> str:
        ...
        profile = await self._get_sdk_client().profiles.create_profile(name=str(name or "").strip())
