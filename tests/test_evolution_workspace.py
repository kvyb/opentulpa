...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("src/opentulpa/web_assets/index.html", True, True),
        ("src/opentulpa/web_assets/app.js", True, True),
        ("src/opentulpa/web_assets/unsafe.py", True, True),
        ("src/opentulpa/interfaces/web.py", True, True),
